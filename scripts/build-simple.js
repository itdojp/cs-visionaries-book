...
`;
  ...
  insertGeneratedNotice(content, srcPath) {
    ...
    const notice = `<!-- generated by scripts/build-simple.js | authoring source: ${sourcePath} | do not edit docs/ directly | navigation canonical: docs/index.md | reader-facing preview: GitHub Pages -->\n\n`;
