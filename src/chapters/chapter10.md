...
2012年10月、トロント大学の研究室。65歳のジェフリー・ヒントンは、コンピュータの画面に映る結果を信じられない思いで見つめていた。ImageNet画像認識コンテストの最終結果が発表された瞬間だった。
...
2018年、ヒントンはヤン・ルカン、ヨシュア・ベンジオとともにACMチューリング賞を受賞し、2024年にはジョン・ホップフィールドとともにノーベル物理学賞を受賞するなど、深層学習の発展における功績が広く認められた。一方で近年、彼はAIの安全性や社会的影響について警鐘を鳴らしている。
...
ヒントンを含む多くの研究者は、AIが非常に強力な汎用技術である以上、技術者だけでなく社会全体でガバナンスと安全性を整備する必要があると指摘している。
