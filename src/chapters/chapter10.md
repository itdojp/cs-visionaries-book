...
ヒントンはヤン・ルカン、ヨシュア・ベンジオとともにACMチューリング賞を受賞し、深層学習の基礎的貢献がコンピュータサイエンス全体に与えた影響が公式に評価された。[^3] また2024年にはジョン・ホップフィールドとともにノーベル物理学賞を受賞し、機械学習を可能にする人工ニューラルネットワークの基礎的発見・発明が物理学として評価された。[^4]
...
timeline
    ...
    2024 : ノーベル物理学賞受賞
         : ジョン・ホップフィールドと共同受賞
         : 機械学習を可能にする人工ニューラルネットワークの基礎的発見・発明
```
...
[^4]: The Nobel Prize in Physics 2024（受賞者：John J. Hopfield, Geoffrey E. Hinton） https://www.nobelprize.org/prizes/physics/2024/summary/
