...
現行版の参照先メモ: [Web / インターネット（第6章）](../chapters/chapter06.html)、[検索（第7章）](../chapters/chapter07.html)、[SNS（第8章）](../chapters/chapter08.html)、[クラウド（第9章）](../chapters/chapter09.html)、[AI（第10章）](../chapters/chapter10.html) です。章番号で迷った場合は、トップページの目次を正としてください。
...
3. [第10章（現代AIの社会実装）](../chapters/chapter10.html) を読み、必要に応じて [付録C](appendix-c.html) の AI 文献で技術史を補う
4. データ/運用/ガバナンスの章（[第6章](../chapters/chapter06.html) / [第7章](../chapters/chapter07.html) / [第2章](../chapters/chapter02.html) / [第9章](../chapters/chapter09.html)）を必要に応じて補完する
...
詳細な年号、出来事の並び、補助的な節目を確認したい場合は、まず [付録A](appendix-a.html) を参照してください。本付録では、AI 時代形成を理解するための代表イベントだけを残しています。
