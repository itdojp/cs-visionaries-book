...
「人間の脳には数百億個のニューロンがある。それを模倣すれば、必ず知能を再現できる」—この信念が、彼を支え続けていた。

あなたが今使っている音声認識、写真の自動タグ付け、リアルタイム翻訳、チャットボットとの対話—これらすべての背景には、一人の老研究者が30年間信じ続けた「機械は学習できる」という夢がある。

ヒントンはヤン・ルカン、ヨシュア・ベンジオとともにACMチューリング賞を受賞し、深層学習の基礎的貢献がコンピュータサイエンス全体に与えた影響が公式に評価された。（ACM: https://awards.acm.org/about/2018-turing）
...
注記: 深層学習の技術史（バックプロパゲーション、2006〜2017の発展）は第16章に詳述する。本章では、生成AIの社会実装へ接続する範囲に絞って扱う。
