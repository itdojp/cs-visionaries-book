...
ヒントンはヤン・ルカン、ヨシュア・ベンジオとともにACMチューリング賞を受賞し、深層学習の基礎的貢献がコンピュータサイエンス全体に与えた影響が公式に評価された。（ACM: https://awards.acm.org/about/2018-turing）また2024年にはジョン・ホップフィールドとともにノーベル物理学賞を受賞し、機械学習を可能にする人工ニューラルネットワークの基礎的発見・発明が物理学として評価された。（Nobel Prize: https://www.nobelprize.org/prizes/physics/2024/summary/）一方で近年、彼はAIの安全性や社会的影響について警鐘を鳴らしている。
