...
GPT-4 (2023): 非公開（推定には幅がある）
```

GPT-4のモデルサイズは競争上・安全上の理由で非開示とされている[^gpt4_params]。
...
2023年、ヒントンはGoogleを退職し、AI の安全性について警告を発し始めた。

**ヒントンの懸念**
ヒントンは、人間を上回る知能を持つ可能性のあるシステムを作ってしまった一方で、その帰結を十分に理解できていない、という趣旨の警鐘を鳴らしている。
...
ヒントンは、自身の研究に対する責任の観点から、リスク議論の必要性を強調している。
