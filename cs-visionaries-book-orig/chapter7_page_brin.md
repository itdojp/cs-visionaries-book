...
「僕は世界を変えたい」—ラリーは友人によくこう語っていた。「コンピュータ技術で、人類の知識へのアクセスを革命的に改善したい」
...
「数学は宇宙の言語だ」—セルゲイの父で数学者のミハイル・ブリンがよく息子に言っていた言葉だった。セルゲイは、この教えを深く信じており、現実世界の複雑な問題を数学的モデルで解決することに情熱を燃やしていた。
...
「これでは図書館として機能しない」—ラリーは不満を抱いていた。「重要な情報も、どうでもいい情報も、同列に扱われている」
...
「これをWebに応用できないか？」—二人は考えた。Webページ間のリンクを「引用」と見なせば、学術論文と同様の分析が可能になる。
...
「これは素晴らしい。他の検索エンジンとは次元が違う」—アンディの感想だった。

デモ終了後、アンディは即座に決断した。「投資したい。いくら必要だ？」
