...
### オプション2: ローカルファイル
1. [design-preview.html](https://raw.githubusercontent.com/itdojp/cs-visionaries-book/main/design-preview.html) を右クリック
2. "名前を付けてリンク先を保存" を選択
...
- **🔄 ライブプレビュー**: [GitHub Pages](https://itdojp.github.io/cs-visionaries-book/)
- **📁 ソースコード**: [design-preview.html](https://github.com/itdojp/cs-visionaries-book/blob/main/design-preview.html)
